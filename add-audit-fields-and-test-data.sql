-- =====================================================
-- Step 1: Add created_by and updated_by audit fields
-- =====================================================
...
-- =====================================================
-- Step 2: Add test meal logs for visualizing scenarios
-- =====================================================
...
BEGIN
  ...
  IF challenge_id IS NULL THEN
    INSERT INTO challenges (title, description, duration_days, start_date, participant_id, participant_name, status, created_by, updated_by)
    VALUES (
...
-- =====================================================
-- Success! Audit fields and test data added!
-- =====================================================
-- Test data includes:
...
--
-- Current expected streak: 3 days (July 26-28)
-- Note: Today (July 28) only has breakfast, so streak is actually 2 complete days
-- =====================================================
