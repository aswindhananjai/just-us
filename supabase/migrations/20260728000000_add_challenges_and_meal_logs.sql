...
CREATE INDEX idx_meal_logs_challenge ON meal_logs(challenge_id);
CREATE INDEX idx_meal_logs_user ON meal_logs(user_id);
CREATE INDEX idx_meal_logs_date ON meal_logs(log_date DESC);
...
-- Insert Anu's 3-Day Meal Challenge
